...
- When Append is on and a buffer exists, a **persistent notice** appears above the transcript: "Append buffer active — new recordings will be appended to the existing transcript. To clear it, press Clear twice." This reminds you a buffer is present and how to clear it
